...
value('tableOfContents', [{
    'id': 'mechanics',
    'title': 'Usa il tour',
    'description': '<p>Benvenuto nel tour del <a href="http://golang.org">linguaggio di programmazione Go</a>. Il tour copre le caratteristiche più importanti del linguaggio, soprattutto:</p>',
    'lessons': ['welcome']
}, {
    'id': 'basics',
    'title': 'Principi di base',
    'description': '<p>Il punto di partenza, impara tutte le basi del linguaggio.</p><p>Dichiarare variabili, chiamare funzioni, e tutto ciò di cui hai bisogno prima di passare alle lezioni successive.</p>',
    'lessons': ['basics', 'flowcontrol', 'moretypes']
}, {
    'id': 'methods',
    'title': 'Metodi e interfacce',
    'description': '<p>Impara come definire metodi nei tipi, come dichiarare interfacce, e come mettere insieme tutto ciò.</p>',
    'lessons': ['methods']
}, {
    'id': 'concurrency',
    'title': 'Concorrenza',
    'description': '<p>Go fornisce primitive per la gestione della concorrenza come parte del core del linguaggio.</p><p>Questo modulo copre goroutines e canali, e come essi sono usati per implementare pattern di concorrenza.</p>',
    'lessons': ['concurrency']
}]).
...
value('translation', {
    ...
    'on': 'Attivato',
    'syntax': 'Sintassi',
    'lineno': 'Numeri di Linea',
    'reset': 'Reinizializza',
    'format': 'Formatta il Codice',
    'kill': 'Termina il Programma',
    'run': 'Esegui',
    'compile': 'Compila ed Esegui',
    'more': 'Opzioni',
    'toc': 'Tabella dei Contenuti',
    'prev': 'Precedente',
    'next': 'Successivo',
    'waiting': 'Aspettando il server remoto...',
    'errcomm': 'Errore di comunicazione con il server remoto.',
    'submit-feedback': 'Invia feedback riguardo questa pagina',

    // GitHub issue template: update repo and messaging when translating.
    'github-repo': 'github.com/golang/go',
    'issue-title': 'tour: [MODIFICA TITOLO CON BREVE DESCRIZIONE]',
    'issue-message': 'Cambia il titolo sopra descrivendo il tuo problema e aggiungi il tuo feedback qui, includendo del codice se necessario',
    'context': 'Contesto',
}).
